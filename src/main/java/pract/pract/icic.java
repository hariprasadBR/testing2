...
public class icic {
	...
	public static void main(String[] args) {
		...
		List<WebElement> liscity = driver.findElements(By.xpath("//li[starts-with(@id,'ui-id')]"));

		for (WebElement c : liscity) {
			String a = c.getText();

			if (a.equalsIgnoreCase(inputcity)) {
				c.click();
			}
